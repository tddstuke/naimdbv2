...
const SearchBar = () => {
  ...
  return (
    <div className=" flex flex-col justify-center items-center bg-black">
      <form className="w-full max-w-lg" onSubmit={handleMovieSubmit}>
        <div className="md:flex md:items-center mb-6">
          ...
          <button
            class="px-4 py-1 text-white bg-gray-600 rounded-md shadow hover:bg-gray-800 md:mt-0 mt-2 md:ml-2 md:mt-0 mt-2 md:w-1/5 w-full"
            type="submit"
          >
            Search
          </button>
      ...
      <form className="w-full max-w-lg" onSubmit={handleShowSubmit}>
        <div className="md:flex md:items-center mb-6">
          <div className="md:w-1/3">
            <label className="block text-white md:text-right mb-1 md:mb-0 pr-4">
              Enter Show Title:
